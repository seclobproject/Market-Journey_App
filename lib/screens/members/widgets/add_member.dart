          ...
          children: [
            ...
            Padding(
              ...
              child: Align(
                  ...
                  child: Text('Name',style: TextStyle(color: marketbgblue, fontSize: 14))),
            ),
            ...
            Padding(
              ...
              child: Align(
                  alignment: Alignment.topLeft,
                  child: Text('Phone',style: TextStyle(color: marketbgblue),)),
            ),
            ...
            Padding(
              ...
              child: Align(
                  alignment: Alignment.topLeft,
                  child: Text('Address',style: TextStyle(color: marketbgblue),)),
            ),
            ...
            Padding(
              ...
              child: Align(
                  alignment: Alignment.topLeft,
                  child: Text('Date of birth',style: TextStyle(color: marketbgblue),)),
            ),
                ...
                child: Center(
                  child:DropdownButtonFormField(
                    decoration: const InputDecoration(
                        ...
                        hintStyle: TextStyle(fontSize: 12,color:marketbgblue)// Remove underline
                    ),
                    isExpanded: true,
            ...
            const Padding(
              ...
              child: Align(
                  alignment: Alignment.topLeft,
                  child: Text('Password',style: TextStyle(color: marketbgblue),)),
            ),
